...
const DashboardPage = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <div
        className={`bg-gray-800 text-white transition-all duration-300 hidden md:flex flex-col overflow-hidden ${sidebarOpen ? "w-64" : "w-16"
          }`}
      >
        <div className="flex items-center justify-between px-4 py-4">
          <h1
            className={`text-lg underline font-bold ${sidebarOpen ? "block" : "hidden"
              }`}
          >
            Dashboard
          </h1>
        ...
        <nav className="flex-1 px-2 py-4 space-y-2">
          <button
            ...
            className={`flex items-center w-full px-2 py-2 rounded hover:bg-gray-700 ${activeSection === "home" ? "bg-gray-700" : ""
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center w-full px-2 py-2 rounded hover:bg-gray-700 ${activeSection === "reports" ? "bg-gray-700" : ""
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center w-full px-2 py-2 rounded hover:bg-gray-700 ${activeSection === "downloads" ? "bg-gray-700" : ""
              }`}
          >
      ...
      <div className="flex-1 flex flex-col">
        ...
        {mobileDropdownOpen && (
          <div className="md:hidden bg-white shadow-lg w-full z-10">
            <button
              onClick={() => handleSectionClick("home")}
              className={`w-full text-left px-4 py-2 flex items-center space-x-2 hover:bg-gray-100 ${activeSection === "home" ? "bg-gray-200" : ""
                }`}
            >
              <FaTachometerAlt />
              <span>Home</span>
            ...
            <button
              onClick={() => handleSectionClick("reports")}
              className={`w-full text-left px-4 py-2 flex items-center space-x-2 hover:bg-gray-100 ${activeSection === "reports" ? "bg-gray-200" : ""
                }`}
            >
              <FaFileAlt />
              <span>Reports</span>
            ...
            <button
              onClick={() => handleSectionClick("downloads")}
              className={`w-full text-left px-4 py-2 flex items-center space-x-2 hover:bg-gray-100 ${activeSection === "downloads" ? "bg-gray-200" : ""
                }`}
            >
              <FaDownload />
              <span>Downloads</span>
